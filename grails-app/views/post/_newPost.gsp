    ...
    <div id="newPost">
        ...
        <p>
            <g:form>
                ...
                %{--
                    SubmitToRemote: Send post via ajax definition
                    value: Creates Ajax link
                    url: Specifies map of params to submit
                    update: Sets id of HTML element to update
                    onSuccess: Handles events generated by the tag
                    onLoading: Handles events generated by the tag
                    onComplete: Handles events generated by the tag
                --}%
