<html ${pageProperty(name:'page.htmlAttrs')}> %{--Which tells Grails to merge in any page-level properties defined as htmlAttrs on your target page--}%
    <head>
        ...
        %{--Resources plugin requires two <r:layoutResources> tags either in a view or its layout--}%
        <r:layoutResources />
    </head>
    <body>
        <div>
